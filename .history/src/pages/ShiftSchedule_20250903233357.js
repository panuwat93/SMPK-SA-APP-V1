                    ...
                    {nurses.length > 5 && (
                      <div className="flex items-center gap-2">
                        ...
                        <span className="text-sm">
                          {visibleMembersStart + 1}-{Math.min(visibleMembersStart + 5, nurses.length)} / {nurses.length}
                        </span>
                        <button
                          onClick={scrollMembersDown}
                          disabled={visibleMembersStart >= nurses.length - 5}
                          className={`px-3 py-1 rounded text-sm font-medium transition-colors ${
                            visibleMembersStart >= nurses.length - 5
                              ? 'bg-gray-300 text-gray-500 cursor-not-allowed'
                              : 'bg-blue-600 hover:bg-blue-700 text-white'
                          }`}
                        >
