...
const OT3C = ({ userData }) => {
  ...
  const [formData, setFormData] = useState({
    ...
    month: '',
    employeeType: '', // ลูกจ้างชั่วคราวรายวัน หรือ ลูกจ้างรายคาบ
    ...
    <div className="min-h-screen bg-white p-4">
      <div className="max-w-7xl mx-auto print-content" style={{ width: '297mm', minHeight: '210mm' }}>
        ...
        <div className="text-center mb-8 no-print">
          <h1 className="text-2xl font-bold text-gray-800 mb-4">แบบฟอร์ม OT-3C</h1>
        </div>
        ...
        <div className="bg-white border border-gray-300 p-6">
          ...
          <div className="mb-6 relative">
            <div className="text-center">
              <p className="text-sm">
                ...
                <input 
                  ...
                  name="employeeType"
                  value="daily"
                  checked={formData.employeeType === 'daily'}
                ...
                <input 
                  ...
                  name="employeeType"
                  value="hourly"
                  checked={formData.employeeType === 'hourly'}
                  onChange={(e) => handleInputChange('', '', 'employeeType', e.target.value)}
                  className="mx-1"
                />
                <span className="mx-1">)</span>
              ...
              <p className="text-sm mt-2">
                ...
                <input 
                  type="text" 
                  className="border-b border-gray-400 mx-2 w-40"
            ...
            <div className="absolute top-0 right-0">
              <p className="text-sm font-bold">แบบฟอร์ม OT - 3C</p>
            </div>
          </div>
            ...
            <table className="w-full border border-gray-400 text-xs">
              <thead>
                <tr className="bg-gray-100">
                  ...
                  <th className="border border-gray-400 p-1 w-48">ชื่อ - สกุล</th>
                  <th className="border border-gray-400 p-1 w-48">ตำแหน่ง</th>
                ...
                <tr className="bg-gray-100">
                  ...
                  {Array.from({ length: 31 }, (_, i) => (
                    <th key={i} className="border border-gray-400 p-1 w-6 text-center">
                      {i + 1}
                    </th>
                  ))}
                  <th className="border border-gray-400 p-1"></th>
              ...
              <tbody>
                {formData.staff.map((staff, staffIndex) => (
                  <tr key={staffIndex}>
                    ...
                    <td className="border border-gray-400 p-1 w-48">
                      <input 
                        type="text" 
          ...
          <div className="mt-6">
            ...
            <div className="text-xs space-y-2">
              <p>
                1. ให้ลงจำนวนชั่วโมงที่ปฏิบัติงานในแต่ละวัน และระบุเวลาที่ปฏิบัติงานในช่องหมายเหตุ
              </p>
              <p>
                2. ให้แนบสำเนาคำสั่งจ้างให้ฝ่ายการเงินฯ ตรวจสอบด้วย
              </p>
            </div>
          </div>
