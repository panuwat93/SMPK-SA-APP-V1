          ...
          <div className="space-y-8">
                  ...
                  <table className="w-full border-collapse">
                    <thead>
                      <tr className="bg-gray-50">
                        <th className="border border-gray-300 px-3 py-2 text-sm font-medium text-gray-700 w-10 sticky-header-left">No.</th>
                        <th className="border border-gray-300 px-3 py-2 text-sm font-medium text-gray-700 w-40 sticky-header-left-name">ชื่อ-นามสกุล</th>
                        {days.map((day, index) => (
                          <th key={index} className={`border border-gray-300 px-2 py-2 text-center w-10 sticky-header ${
                        ...
                        <th className="border border-gray-300 px-3 py-2 text-sm font-medium text-gray-700 w-16 sticky-header">เวรรวม</th>
                        <th className="border border-gray-300 px-3 py-2 text-sm font-medium text-gray-700 w-16 sticky-header">OT</th>
                        <th className="border border-gray-300 px-3 py-2 text-sm font-medium text-gray-700 w-16 sticky-header">ค่าเวร</th>
                      </tr>
                    </thead>
                    <tbody>
                      {nurses.map((nurse, index) => (
                        <React.Fragment key={nurse.id}>
                          {/* แถวที่ 1: ช่องเวรบน */}
                          <tr className="h-8">
                            <td rowSpan="2" className="border border-gray-300 px-3 py-2 text-center text-sm font-medium bg-gray-50 align-middle sticky-cell">
                              {index + 1}
                            </td>
                            <td rowSpan="2" className="border border-gray-300 px-3 py-2 text-center text-sm font-medium align-middle sticky-cell-name">
            ...
            {assistants.length > 0 && (viewMode === 'all' || viewMode === 'assistants') && (
              <div className="bg-white/90 backdrop-blur-sm rounded-xl shadow-xl border border-blue-200/50 overflow-hidden">
                ...
                <div className="overflow-auto max-h-screen" style={{ position: 'relative' }}>
                      ...
                      {assistants.map((assistant, index) => (
                        <React.Fragment key={assistant.id}>
                          ...
                          <tr className="h-8">
                            ...
                            <td rowSpan="2" className="border border-gray-300 px-3 py-2 text-sm font-medium align-middle sticky-cell-name">
                    ...
                    <thead>
                      <tr className="bg-gray-100">
                        ...
                        {Array.from({ length: new Date(currentMonth.getFullYear(), currentMonth.getMonth() + 1, 0).getDate() }, (_, i) => {
                          ...
                          return (
                            <th key={date} className={`border border-gray-300 px-2 py-2 text-center w-10 sticky-header ${
                          ...
                          return filteredMembers.map((member, index) => (
                            <React.Fragment key={member.id}>
                              ...
                              <tr className="h-8">
                                <td 
                                  rowSpan={2}
                                  className="border border-gray-300 px-3 py-2 text-center text-sm font-medium bg-gray-50 align-middle sticky-cell"
                                >
                                  {index + 1}
                                </td>
                                <td 
                                  rowSpan={2}
                                  className="border border-gray-300 px-3 py-2 text-center text-sm font-medium align-middle sticky-cell-name"
                                >
