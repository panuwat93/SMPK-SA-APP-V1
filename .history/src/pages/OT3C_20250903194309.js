              ...
              <thead>
                ...
                <tr className="bg-gray-100">
                  ...
                  {Array.from({ length: 31 }, (_, i) => (
                    <th key={i} className="border border-gray-400 p-1 w-8 text-center" style={{ width: '32px', minWidth: '32px' }}>
                      {i + 1}
                    </th>
                  ))}
                  <th className="border border-gray-400 p-1"></th>
                ...
                {formData.staff.map((staff, staffIndex) => (
                  <tr key={staffIndex}>
                    ...
                    {staff.days.map((day, dayIndex) => (
                      <td key={dayIndex} className="border border-gray-400 p-1 w-8" style={{ width: '32px', minWidth: '32px' }}>
                        <input 
                          type="text" 
                          className="w-full text-center border-none outline-none"
                          value={day}
