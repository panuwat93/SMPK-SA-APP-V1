          ...
          <div className="bg-white/90 backdrop-blur-sm rounded-xl shadow-xl p-6 text-center border border-blue-200/50">
            ...
            <div className="mt-4">
              <button
                ...
                className="px-4 py-2 bg-green-200 text-green-800 rounded-lg hover:bg-green-300 transition-colors"
              >
                ไปหน้า Settings
              </button>
            </div>
          ...
          <div className="bg-white rounded-xl p-6 w-[95%] max-w-8xl max-h-[90vh] overflow-y-auto">
            ...
            <div className="space-y-4">
              ...
              <div className="bg-blue-50 p-3 rounded-lg text-sm">
                ...
                <div>พยาบาล: {teamMembers.filter(m => 
                  m.role === 'พยาบาลวิชาชีพชำนาญการพิเศษ' ||
                  m.role === 'พยาบาลวิชาชีพชำนาญการ' ||
                  m.role === 'พยาบาลวิชาชีพปฏิบัติการ' ||
                  m.role === 'พยาบาลวิชาชีพ'
                ).length} คน</div>
