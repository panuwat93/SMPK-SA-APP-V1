                ...
                <div className="overflow-x-auto">
                  <div className="max-h-[400px] overflow-y-auto">
                    ...
                    <tbody>
                      ...
                      <tr className="bg-blue-50 text-blue-800 border-b-2 border-blue-200 sticky top-10 z-10">
                        <td colSpan="2" className="border border-gray-300 px-3 py-2 text-sm font-medium">สรุป พยาบาล</td>
              ...
              <div className="bg-white/90 backdrop-blur-sm rounded-xl shadow-xl border border-blue-200/50 overflow-hidden">
                ...
                <div className="overflow-x-auto">
                  <div className="max-h-[400px] overflow-y-auto">
                    ...
                    <tbody>
                      {/* แถวสรุป (ย้ายขึ้นบน และ sticky เหมือนวันที่) */}
                      <tr className="bg-green-50 text-green-800 border-b-2 border-green-200 sticky top-10 z-10">
                        <td colSpan="2" className="border border-gray-300 px-3 py-2 text-sm font-medium">สรุป ผู้ช่วยพยาบาล/ผู้ช่วยเหลือคนไข้</td>
                        {days.map((day, dayIndex) => {
