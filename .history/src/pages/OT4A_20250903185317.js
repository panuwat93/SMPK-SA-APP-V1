            ...
            <table className="w-full border border-gray-400" style={{ fontSize: '8px' }}>
              <thead>
                <tr className="bg-gray-100">
                  <th className="border border-gray-400 p-1" style={{ width: '1cm', fontSize: '6px' }}>ลำดับ</th>
                  <th className="border border-gray-400 p-1 w-32" style={{ fontSize: '6px' }}>ชื่อ</th>
                  <th className="border border-gray-400 p-1" style={{ width: '1cm', fontSize: '6px' }}>อัตราค่าจ้าง/ค่าตอบแทน</th>
                  <th className="border border-gray-400 p-1 text-center" colSpan="31" style={{ fontSize: '6px' }}>วันที่ปฏิบัติงาน(21-20)</th>
                  <th className="border border-gray-400 p-1" style={{ width: '1cm', fontSize: '6px' }}>รวมวัน/ชม.ปฏิบัติงาน</th>
                  <th className="border border-gray-400 p-1" style={{ width: '1cm', fontSize: '6px' }}>รวมเงิน</th>
                  <th className="border border-gray-400 p-1" style={{ width: '1cm', fontSize: '6px' }}>ลายมือชื่อผู้ปฏิบัติงานจริง</th>
                  <th className="border border-gray-400 p-1" style={{ width: '1cm', fontSize: '6px' }}>ลายมือชื่อผู้รับเงิน</th>
                </tr>
                <tr className="bg-gray-100">
                  ...
                  {Array.from({ length: 11 }, (_, i) => (
                    <th key={i} className="border border-gray-400 p-1 w-8 text-center" style={{ fontSize: '6px' }}>
                      {i + 21}
                    </th>
                  ))}
                  {/* Days 1-20 (current month) */}
                  {Array.from({ length: 20 }, (_, i) => (
                    <th key={i + 11} className="border border-gray-400 p-1 w-8 text-center" style={{ fontSize: '6px' }}>
                      {i + 1}
                    </th>
                  ))}
                  <th className="border border-gray-400 p-1" style={{ fontSize: '6px' }}></th>
                 ...
                 {formData.staff.map((staff, staffIndex) => (
                   <tr key={staffIndex}>
                     <td className="border border-gray-400 p-1" style={{ width: '1cm' }}>
                       <input 
                         type="text" 
                     ...
                     <td className="border border-gray-400 p-1 relative" style={{ width: '1cm' }}>
                       <input 
                         type="text" 
                         className="w-full text-center border-none outline-none"
