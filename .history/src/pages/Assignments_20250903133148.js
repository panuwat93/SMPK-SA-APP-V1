      ...
      <div className="mb-6 bg-white/90 backdrop-blur-sm rounded-xl p-6 shadow-lg border border-gray-200">
        <div className="flex items-center justify-between">
          ...
          <div className="text-center flex-1">
            <h1 className="text-3xl font-bold text-gray-800">ตารางมอบหมายงาน</h1>
          ...
          <div className="flex items-center gap-4 flex-1 justify-end">
            <button
              ...
              className="p-2 rounded-full bg-green-50 hover:bg-green-100 text-green-600 transition-colors border border-green-200"
            >
