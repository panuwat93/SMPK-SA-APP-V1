...
const Settings = ({ userData }) => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-indigo-50 to-slate-100 p-6">
      <div className="max-w-6xl mx-auto">
        <div className="mb-8 bg-white/80 backdrop-blur-sm rounded-xl p-6 shadow-lg border border-blue-100">
          <h1 className="text-3xl font-bold text-slate-800">ตั้งค่า</h1>
          <p className="text-slate-600 mt-2 font-medium">แผนก: {userData?.department}</p>
        </div>
