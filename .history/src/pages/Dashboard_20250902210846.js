...
const Dashboard = ({ user }) => {
  ...
  useEffect(() => {
    ...
    fetchScheduleData();
  }, [currentDate, user?.uid, teamMembers]);
  ...
  const getStaffShifts = (date) => {
    ...
    const memberIndex = teamMembers.findIndex(member => member.uid === user.uid);
          ...
          <div className="mt-8 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <div className="bg-white p-6 rounded-lg shadow-md border border-gray-200 hover:shadow-lg transition-shadow cursor-pointer">
              <div className="flex items-center mb-4">
                ...
                <h3 className="text-xl font-semibold text-dark-blue">ตารางเวร</h3>
              </div>
            ...
            <div className="bg-white p-6 rounded-lg shadow-md border border-gray-200 hover:shadow-lg transition-shadow cursor-pointer">
              <div className="flex items-center mb-4">
                ...
                <h3 className="text-xl font-semibold text-dark-blue">ตารางมอบหมายงาน</h3>
              </div>
            ...
            <div className="bg-white p-6 rounded-lg shadow-md border border-gray-200 hover:shadow-lg transition-shadow cursor-pointer">
              <div className="flex items-center mb-4">
                ...
                <h3 className="text-xl font-semibold text-dark-blue">แลกเวร</h3>
              </div>
