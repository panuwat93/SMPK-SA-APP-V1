          ...
          <div className="bg-white rounded-xl sm:rounded-2xl shadow-lg border border-gray-100 overflow-hidden">
            ...
            <div className="bg-gradient-to-r from-blue-600 to-indigo-600 text-white p-4 sm:p-6">
              <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
                <h2 className="text-xl sm:text-2xl font-bold">ปฏิทินเวรของฉัน</h2>
                        ...
                        <tr key={weekIndex} className="border-b border-gray-100">
                          {week.map((date, dayIndex) => {
                            ...
                            return (
                              <td 
                                key={dayIndex} 
                                className={`p-1 sm:p-2 h-16 sm:h-20 md:h-24 w-12 sm:w-16 md:w-24 align-top ${
                              ...
                              >
                                <div className="flex flex-col h-full">
                                  ...
                                  {topShift && topShift.trim() !== '' && (
                                    <div 
                                      className={`text-xs px-0.5 sm:px-1 py-0.5 rounded mb-1 ${
