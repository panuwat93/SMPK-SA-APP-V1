                  ...
                  <table className="w-full border-collapse border border-gray-300 text-xs">
                    <thead>
                      <tr className="bg-gray-100">
                        ...
                        <th className="border border-gray-300 px-0.5 py-0.5 text-xs font-medium text-gray-700 w-15 sticky left-4 top-0 bg-gray-100 z-20">ชื่อ-นามสกุล</th>
                          ...
                          return filteredMembers.map((member, index) => (
                            <React.Fragment key={member.id}>
                              ...
                              <tr className="h-8">
                                  ...
                                  <td 
                                    rowSpan={2}
                                    className="border border-gray-300 px-0.5 py-0.5 text-center text-xs font-medium align-middle sticky left-4 bg-white z-10 w-15"
                                  >
