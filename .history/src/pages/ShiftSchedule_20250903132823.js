        ...
        <div className="mb-6 bg-white/90 backdrop-blur-sm rounded-xl p-6 shadow-lg border border-gray-200">
              ...
              <div className="flex justify-start gap-3">
                ...
                <button
                  ...
                  className="px-3 py-1.5 bg-purple-200 hover:bg-purple-300 text-purple-800 rounded text-sm font-medium transition-colors"
                >
                ...
                <button
                  ...
                  className="px-3 py-1.5 bg-pink-200 hover:bg-pink-300 text-pink-800 rounded text-sm font-medium transition-colors"
                >
                ...
                <button
                  ...
                  className="px-3 py-1.5 bg-orange-200 hover:bg-orange-300 text-orange-800 rounded text-sm font-medium transition-colors"
                >
