          ...
          <div>
                 ...
                 {formData.staff.map((staff, staffIndex) => (
                   <tr key={staffIndex}>
                     ...
                     <td className="border border-gray-400 p-1 relative" style={{ width: '0.8cm' }}>
                       ...
                       {staffIndex === 7 && (
                         <div className="absolute -bottom-6 left-0 right-0 border border-gray-400 p-1 bg-white" style={{ fontSize: '6px' }}>
                           <input 
                             type="text" 
                             className="w-full text-center border-none outline-none"
           ...
           <div className="mt-2 text-center">
             <p className="text-sm">
               ...
               รวมทั้งสิ้น {numberToThaiText(formData.staff.reduce((sum, staff) => sum + (parseFloat(staff.totalAmount) || 0), 0))}
             </p>
           </div>
