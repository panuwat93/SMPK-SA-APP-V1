        ...
        <div className="bg-white border border-gray-300 p-6">
            ...
            <table className="w-full border border-gray-400 text-xs">
              <thead>
                <tr className="bg-gray-100">
                  ...
                  <th className="border border-gray-400 p-1 text-center" colSpan="32">วันที่ปฏิบัติงาน</th>
                  <th className="border border-gray-400 p-1 w-20">รวมเงิน</th>
                  <th className="border border-gray-400 p-1 w-24">ลายมือชื่อ ผู้ปฏิบัติงานจริง</th>
                  <th className="border border-gray-400 p-1 w-24">ลายมือชื่อ ผู้รับเงิน</th>
                </tr>
                <tr className="bg-gray-100">
                  <th className="border border-gray-400 p-1"></th>
                  <th className="border border-gray-400 p-1"></th>
                  <th className="border border-gray-400 p-1 text-center" colSpan="11">ค่าตอบแทน</th>
                  <th className="border border-gray-400 p-1 text-center" colSpan="21">วันที่</th>
                  <th className="border border-gray-400 p-1"></th>
                  <th className="border border-gray-400 p-1"></th>
                  <th className="border border-gray-400 p-1"></th>
                </tr>
                <tr className="bg-gray-100">
                  ...
                  <th className="border border-gray-400 p-1 w-8 text-center">รวมวัน/ม.</th>
                  <th className="border border-gray-400 p-1"></th>
                  <th className="border border-gray-400 p-1"></th>
                  <th className="border border-gray-400 p-1"></th>
                </tr>
          ...
          <div className="mt-6 grid grid-cols-2 gap-8">
            ...
            <div>
             ...
             <div>
               <div className="mb-4">
                 <div className="border-b border-gray-400 mb-2 h-6 w-32 mx-auto"></div>
                 <p className="text-xs text-center">รวมทั้งสิ้น</p>
               </div>
               ...
               <div className="grid grid-cols-3 gap-4">
                 ...
                 <div className="text-center">
                   <div className="border-b border-gray-400 mb-2 h-6"></div>
                   <p className="text-xs">ลงชื่อ</p>
                   <p className="text-xs">หัวหน้าผู้ควบคุม</p>
                   <div className="border-b border-gray-400 mb-2 h-6"></div>
                   <p className="text-xs">ตำแหน่ง</p>
                   <div className="border-b border-gray-400 mb-2 h-6"></div>
                   <p className="text-xs">( )</p>
