            ...
            <table className="w-full border border-gray-400" style={{ fontSize: '8px' }}>
              <thead>
                <tr className="bg-gray-100">
                  <th className="border border-gray-400 p-1" style={{ width: '1cm' }}>ลำดับ</th>
                  <th className="border border-gray-400 p-1 w-32">ชื่อ</th>
                  <th className="border border-gray-400 p-1" style={{ width: '1cm' }}>อัตราค่าจ้าง/ค่าตอบแทน</th>
                  <th className="border border-gray-400 p-1 text-center" colSpan="31">วันที่ปฏิบัติงาน(21-20)</th>
                  <th className="border border-gray-400 p-1" style={{ width: '1cm' }}>รวมวัน/ชม.ปฏิบัติงาน</th>
                  <th className="border border-gray-400 p-1" style={{ width: '1cm' }}>รวมเงิน</th>
                  <th className="border border-gray-400 p-1" style={{ width: '1cm' }}>ลายมือชื่อผู้ปฏิบัติงานจริง</th>
                  <th className="border border-gray-400 p-1" style={{ width: '1cm' }}>ลายมือชื่อผู้รับเงิน</th>
                </tr>
                <tr className="bg-gray-100">
                 ...
                 {formData.staff.map((staff, staffIndex) => (
                   <tr key={staffIndex}>
                     ...
                     <td className="border border-gray-400 p-1" style={{ width: '1.5cm' }}>
                       <input 
                         type="text" 
                         className="w-full border-none outline-none"
                         value={staff.rate}
