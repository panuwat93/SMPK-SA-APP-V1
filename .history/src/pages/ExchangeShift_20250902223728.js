...
const ExchangeShift = ({ userData }) => {
  ...
  const fetchAllExchangeRequests = async () => {
    try {
      console.log('Fetching exchange requests for department:', userData.department);
      ...
      console.log('Found exchange requests:', requests);
      ...
      try {
        ...
        console.log('All exchange requests:', allRequests);
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="mb-4 p-4 bg-yellow-100 rounded-lg">
            <p className="text-sm text-gray-700">
              <strong>Debug:</strong> Department: {userData.department} | 
              Requests Count: {allExchangeRequests.length} | 
