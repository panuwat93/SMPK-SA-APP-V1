...
const ShiftSchedule = ({ userData }) => {
  ...
  // เลือกช่อง
  const selectCell = (memberId, dayIndex, rowType) => {
    const cellKey = `${memberId}-${dayIndex}-${rowType}`;
    setSelectedCell(cellKey);
    console.log('เลือกช่อง:', cellKey);
  };
  ...
  const changeTextColor = (color) => {
    ...
    if (selectedCell) {
      ...
      addToHistory({
        ...
        oldValue: cellValues[selectedCell] || '',
        newValue: cellValues[selectedCell] || '',
        oldColor: textColor,
        newColor: color
      });
      
      // อัปเดตสีในช่องที่เลือก
      updateCellStyle(selectedCell, color, fontSize);
    }
  };
  ...
  const changeFontSize = (size) => {
    ...
    if (selectedCell) {
      ...
      updateCellStyle(selectedCell, textColor, size);
    }
  };
  ...
  const addShiftToSelectedCell = (shiftName) => {
    if (selectedCell) {
      const oldValue = cellValues[selectedCell] || '';
      ...
      setCellValues(prev => ({
        ...prev,
        [selectedCell]: shiftName
      }));
      
      // บันทึกลง Firebase
      const [memberId, dayIndex, rowType] = selectedCell.split('-');
              ...
              <div className="flex items-center gap-4 bg-gray-100 px-4 py-2 rounded-lg">
                ...
                <div className="flex items-center gap-2">
                  ...
                  {shiftOptions.map(option => (
                    <button
                      ...
                      className="px-2 py-1 rounded text-white font-medium text-sm transition-all hover:scale-105"
                      style={{ 
                ...
                <div className="flex items-center gap-2">
                  <button
                    ...
                    className={`px-3 py-1 rounded text-white font-medium transition-all flex items-center gap-2 ${
                      history.length === 0 
                            ...
                            {days.map((day, dayIndex) => {
                              ...
                              return (
                                <td 
                                  ...
                                  onClick={() => {
                                    selectCell(nurse.id, dayIndex, 'top');
                            ...
                            {days.map((day, dayIndex) => {
                              ...
                              return (
                                <td 
                                  ...
                                  onClick={() => {
                                    selectCell(nurse.id, dayIndex, 'bottom');
                            ...
                            {days.map((day, dayIndex) => {
                              ...
                              return (
                                <td 
                                  ...
                                  onClick={() => {
                                    selectCell(assistant.id, dayIndex, 'top');
                            ...
                            {days.map((day, dayIndex) => {
                              ...
                              return (
                                <td 
                                  ...
                                  onClick={() => {
                                    selectCell(assistant.id, dayIndex, 'bottom');
