      ...
      <div className="w-full">
        ...
        <div className="mb-6 bg-white/90 backdrop-blur-sm rounded-xl p-6 shadow-lg border border-gray-200">
          ...
          <div className="mt-4 p-3 bg-gray-50 rounded-lg border border-gray-200">
            <p className="text-sm text-gray-800 font-medium">ข้อมูล Debug:</p>
            <p className="text-sm text-gray-700">{debugInfo}</p>
            <p className="text-sm text-gray-700">จำนวนสมาชิกทั้งหมด: {teamMembers.length} คน</p>
            <p className="text-sm text-gray-700">พยาบาล: {nurses.length} คน</p>
            <p className="text-sm text-gray-700">ผู้ช่วยพยาบาล: {nursingAssistants.length} คน</p>
            <p className="text-sm text-gray-700">พนักงานผู้ช่วยเหลือคนไข้: {patientHelpers.length} คน</p>
            <p className="text-sm text-gray-700">รวมตารางผู้ช่วย: {assistants.length} คน</p>
            {teamMembers.length > 0 && (
              <div className="mt-2">
                <p className="text-sm text-gray-700 font-medium">รายชื่อสมาชิกในทีม:</p>
