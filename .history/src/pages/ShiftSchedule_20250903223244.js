    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-indigo-50 to-slate-100 p-4">
      <div className="w-full">
        ...
        <div className="mb-6 bg-white/90 backdrop-blur-sm rounded-xl p-6 shadow-lg border border-gray-200">
              ...
              <div className="flex justify-start gap-3">
                {canEditSchedule && (
                  <>
                    ...
                    {/* ปุ่มเพิ่มวันหยุดเฉพาะหัวหน้าหน่วยงาน */}
                ...
                {/* ปุ่มสำหรับหัวหน้าหน่วยงานเท่านั้น */}
                {userData?.role === 'หัวหน้าหน่วยงาน' && (
                  <>
                    <button
            ...
            {/* แถบเครื่องมือ - แสดงเฉพาะหัวหน้าหน่วยงาน */}
            {canEditSchedule && userData?.role === 'หัวหน้าหน่วยงาน' && (
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white rounded-xl p-6 w-[95%] max-w-8xl max-h-[90vh] overflow-y-auto">
            ...
            <div className="flex gap-3 mt-6">
              {/* ปุ่มบันทึกภาพสำหรับหัวหน้าหน่วยงานเท่านั้น */}
              {userData?.role === 'หัวหน้าหน่วยงาน' && (
                <button
              ...
              <button
                ...
                className={`px-4 py-2 bg-gray-300 hover:bg-gray-400 text-gray-700 rounded-lg font-medium transition-colors ${
                  userData?.role === 'หัวหน้าหน่วยงาน' ? 'flex-1' : 'w-full'
                }`}
              >
                ปิด
              </button>
