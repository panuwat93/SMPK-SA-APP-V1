      ...
      {isSupervisor ? (
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4 sm:gap-6 md:gap-8">
            {/* ตารางเวร */}
            <div className="group bg-white p-4 sm:p-6 md:p-8 rounded-2xl shadow-lg border border-gray-100 hover:shadow-xl hover:scale-105 transition-all duration-300 cursor-pointer">
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 mb-8">
            <div className="group bg-white p-4 sm:p-6 rounded-2xl shadow-lg border border-gray-100 hover:shadow-xl hover:scale-105 transition-all duration-300 cursor-pointer">
              <div className="flex items-center justify-center w-16 h-16 bg-gradient-to-r from-blue-500 to-blue-600 rounded-xl mb-6 group-hover:scale-110 transition-transform duration-300">
                <svg className="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" />
                </svg>
              ...
              <h3 className="text-2xl font-bold text-gray-800 mb-4">ตารางเวร</h3>
              <p className="text-gray-600 leading-relaxed">ดูตารางเวรของหน่วยงาน</p>
            </div>
            ...
            <div className="group bg-white p-4 sm:p-6 rounded-2xl shadow-lg border border-gray-100 hover:shadow-xl hover:scale-105 transition-all duration-300 cursor-pointer">
              ...
              <h3 className="text-2xl font-bold text-gray-800 mb-4">ตารางมอบหมายงาน</h3>
              <p className="text-gray-600 leading-relaxed">ดูการมอบหมายงานในแต่ละเวร</p>
            </div>
            ...
            <div className="group bg-white p-4 sm:p-6 rounded-2xl shadow-lg border border-gray-100 hover:shadow-xl hover:scale-105 transition-all duration-300 cursor-pointer">
              ...
              <p className="text-gray-600 leading-relaxed">แลกเปลี่ยนเวรกับเพื่อนร่วมงาน</p>
            </div>
          </div>
