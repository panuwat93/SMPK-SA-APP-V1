    ...
    <div className="min-h-screen bg-white p-4">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="bg-white border border-gray-300 p-6">
          ...
          <div className="mb-6 flex justify-between items-center">
            <div>
              <p className="text-sm">
                ...
                <input 
                  type="text" 
                  className="border-b border-gray-400 mx-2 w-20 text-center"
            ...
            <div className="text-right">
              <p className="text-sm font-bold transform -rotate-90 origin-center">แบบฟอร์ม OT - 3A</p>
            </div>
          </div>
          ...
          <div className="mt-8 grid grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <p className="text-xs mt-1">ตำแหน่ง</p>
            ...
            <div className="text-center">
              <div className="border-b border-gray-400 mb-2 h-8"></div>
              <p className="text-xs">ผู้จัดตารางเวร</p>
              <p className="text-xs mt-1">ตำแหน่ง</p>
              <p className="text-xs mt-1">วันที่</p>
            </div>
          </div>
        ...
        <div className="mt-6 flex justify-center gap-4">
          ...
          <button className="px-6 py-2 bg-blue-200 hover:bg-blue-300 text-blue-800 rounded-lg font-medium transition-colors">
            พิมพ์
          </button>
        </div>
      </div>
