                ...
                <table className="w-full">
                  <thead className="bg-gray-50">
                    <tr>
                      ...
                      <th className="px-6 py-4 text-left text-sm font-semibold text-gray-800">แลกกับ</th>
                      ...
                      <tr key={request.id} className="hover:bg-gray-50">
                        ...
                        <td className="px-6 py-4 text-sm">
                          <div className="flex items-center space-x-2">
                            <span className="text-gray-600">เวร{request.myShiftType === 'top' ? 'บน' : 'ล่าง'}:</span>
                            <span 
                        ...
                        <td className="px-6 py-4 text-sm">
                          <div className="flex items-center space-x-2">
                            <span className="text-gray-600">เวร{request.otherShiftType === 'top' ? 'บน' : 'ล่าง'}:</span>
                            <span 
                              className="px-2 py-1 rounded text-xs font-medium"
                              style={{
