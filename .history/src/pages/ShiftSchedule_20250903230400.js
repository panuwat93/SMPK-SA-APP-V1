              ...
              <div className="flex items-center gap-3">
                ...
                {shiftOptions.filter(option => !['ช', 'บ', 'ด'].includes(option.name)).map(option => (
                  <button
                    ...
                    style={{ 
                      backgroundColor: option.name === 'O' ? '#ffffff' : (option.backgroundColor || '#6b7280'),
                      color: option.name === 'O' ? '#dc2626' : (option.textColor || '#ffffff'),
                      border: option.name === 'O' ? '1px solid #d1d5db' : 'none'
                    }}
                    title={option.name}
                  >
                    {option.name}
