                         ...
                         s.overviewType === 'nurses'
                          ...
                          return (
                            <div 
                              ...
                              dangerouslySetInnerHTML={{ __html: DOMPurify.sanitize(nurseOverview.tableHTML) }}
                            />
                          );
                        } else {
                         return (
                         ...
                         s.overviewType === 'assistants'
                          ...
                          return (
                            <div 
                              ...
                              dangerouslySetInnerHTML={{ __html: DOMPurify.sanitize(assistantOverview.tableHTML) }}
                            />
                          );
                        } else {
                         return (
                ...
                >
                 ...
                 {selectedImage.tableHTML ? (
                   <div 
                     ...
                     dangerouslySetInnerHTML={{ __html: DOMPurify.sanitize(selectedImage.tableHTML) }}
                   />
                 ) : (
