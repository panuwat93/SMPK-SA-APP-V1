                    ...
                    <tbody>
                      {nurses.map((nurse, index) => (
                        <React.Fragment key={nurse.id}>
                          {/* แถวที่ 1: ชื่อ */}
                          <tr>
                            <td className="border border-gray-300 px-3 py-2 text-center text-sm font-medium bg-gray-50" rowSpan="2">
                              {index + 1}
                            </td>
                            <td className="border border-gray-300 px-3 py-2 text-sm font-medium" rowSpan="2">
                            ...
                            <td className="border border-gray-300 px-3 py-2 text-center text-sm font-medium bg-gray-50" rowSpan="2">0</td>
                            <td className="border border-gray-300 px-3 py-2 text-center text-sm font-medium bg-gray-50" rowSpan="2">0</td>
                            <td className="border border-gray-300 px-3 py-2 text-center text-sm font-medium bg-gray-50" rowSpan="2">0</td>
                          </tr>
                          {/* แถวที่ 2: ตำแหน่ง */}
                    ...
                    <tbody>
                      {assistants.map((assistant, index) => (
                        <React.Fragment key={assistant.id}>
                          {/* แถวที่ 1: ชื่อ */}
                          <tr>
                            <td className="border border-gray-300 px-3 py-2 text-center text-sm font-medium bg-gray-50">
                              {index + 1}
                            </td>
                            ...
                            <td className="border border-gray-300 px-3 py-2 text-center text-sm font-medium bg-gray-50">0</td>
                            <td className="border border-gray-300 px-3 py-2 text-center text-sm font-medium bg-gray-50">0</td>
                            <td className="border border-gray-300 px-3 py-2 text-center text-sm font-medium bg-gray-50">0</td>
                          </tr>
                          {/* แถวที่ 2: ตำแหน่ง */}
