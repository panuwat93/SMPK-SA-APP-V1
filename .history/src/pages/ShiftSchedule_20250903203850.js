...
const ShiftSchedule = ({ userData }) => {
  ...
  // พิมพ์ภาพรวม (สำหรับเจ้าหน้าที่ทั่วไป)
  const printOverview = () => {
    // Add print styles
    const printStyles = `
      @page {
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white rounded-xl p-6 w-[95%] max-w-8xl max-h-[90vh] overflow-y-auto">
            ...
            <div className="space-y-4">
              {/* Debug Information - ซ่อนเมื่อพิมพ์ */}
              <div className="bg-blue-50 p-3 rounded-lg text-sm no-print">
              ...
              {/* เลือกประเภทตาราง - ซ่อนเมื่อพิมพ์ */}
              ...
              {/* แสดงตารางภาพรวม */}
              <div className="bg-gray-50 p-4 rounded-lg print-content">
                  ...
                  <table className="w-full border-collapse border border-gray-300 text-xs">
                    <thead>
                      <tr className="bg-gray-100">
                        <th className="border border-gray-300 px-0.5 py-0.5 text-xs font-medium text-gray-700 w-5 sticky left-0 top-0 bg-gray-100 z-20">No.</th>
                        <th className="border border-gray-300 px-0.5 py-0.5 text-xs font-medium text-gray-700 w-16 sticky left-5 top-0 bg-gray-100 z-20">ชื่อ-นามสกุล</th>
                        {Array.from({ length: new Date(currentMonth.getFullYear(), currentMonth.getMonth() + 1, 0).getDate() }, (_, i) => {
                          ...
                          return (
                            <th key={date} className={`border border-gray-300 px-0.5 py-0.5 text-center w-4 sticky top-0 z-20 ${
                          ...
                          return filteredMembers.map((member, index) => (
                            <React.Fragment key={member.id}>
                              ...
                              <tr className="h-8">
                                <td 
                                  rowSpan={2}
                                  className="border border-gray-300 px-0.5 py-0.5 text-center text-xs font-medium bg-gray-50 align-middle sticky left-0 bg-gray-50 z-10 w-5"
                                >
                                  {index + 1}
                                </td>
                                <td 
                                  rowSpan={2}
                                  className="border border-gray-300 px-0.5 py-0.5 text-center text-xs font-medium align-middle sticky left-5 bg-white z-10 w-16"
                                >
                                ...
                                {Array.from({ length: new Date(currentMonth.getFullYear(), currentMonth.getMonth() + 1, 0).getDate() }, (_, dayIndex) => {
                                  ...
                                  return (
                                    <td 
                                      ...
                                      className={`border border-gray-300 px-0.5 py-0.5 text-center w-4 ${
                                ...
                                {Array.from({ length: new Date(currentMonth.getFullYear(), currentMonth.getMonth() + 1, 0).getDate() }, (_, dayIndex) => {
                                  ...
                                  return (
                                    <td 
                                      ...
                                      className={`border border-gray-300 px-1 py-1 text-center w-6 ${
                                        isHolidayDate ? 'bg-orange-50' : 
                                        isWeekend ? 'bg-yellow-50' : ''
                                      }`}
                                    >
