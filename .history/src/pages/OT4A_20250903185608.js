            ...
            <table className="w-full border border-gray-400" style={{ fontSize: '8px' }}>
              <thead>
                <tr className="bg-gray-100">
                  ...
                  <th className="border border-gray-400 p-1 text-center" colSpan="31" style={{ fontSize: '8px' }}>วันที่ปฏิบัติงาน(21-20)</th>
                ...
                <tr className="bg-gray-100">
                  ...
                  {Array.from({ length: 11 }, (_, i) => (
                    <th key={i} className="border border-gray-400 p-1 w-6 text-center" style={{ fontSize: '6px' }}>
                      {i + 21}
                    </th>
                  ))}
                  {/* Days 1-20 (current month) */}
                  {Array.from({ length: 20 }, (_, i) => (
                    <th key={i + 11} className="border border-gray-400 p-1 w-6 text-center" style={{ fontSize: '6px' }}>
                      {i + 1}
                    </th>
                  ))}
                  <th className="border border-gray-400 p-1" style={{ fontSize: '6px' }}></th>
