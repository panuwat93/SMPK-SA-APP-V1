                      ...
                      {nurses.map((nurse, index) => (
                        <React.Fragment key={nurse.id}>
                          ...
                          <tr className="h-8 border-b-2 border-gray-400">
                            <td rowSpan="2" className="border-2 border-gray-400 px-3 py-2 text-center text-sm font-medium bg-gray-50 align-middle">
                              {index + 1}
                            </td>
                            <td rowSpan="2" className="border-2 border-gray-400 px-3 py-2 text-sm font-medium align-middle">
                            ...
                            <td rowSpan="2" className="border-2 border-gray-400 px-3 py-2 text-center text-sm font-medium bg-gray-50 align-middle">0</td>
                            <td rowSpan="2" className="border-2 border-gray-400 px-3 py-2 text-center text-sm font-medium bg-gray-50 align-middle">0</td>
                            <td rowSpan="2" className="border-2 border-gray-400 px-3 py-2 text-center text-sm font-medium bg-gray-50 align-middle">0</td>
                          </tr>
                          {/* แถวที่ 2: ตำแหน่ง */}
