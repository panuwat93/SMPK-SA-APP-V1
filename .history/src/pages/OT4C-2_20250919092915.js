      ...
      <div className="max-w-7xl mx-auto print-content" style={{ width: '297mm', minHeight: '210mm' }}>
        ...
        <div className="text-center mb-8 no-print">
          <h1 className="text-2xl font-bold text-gray-800 mb-4">
            ...
            {dailyStaff.length > 0 && (
              <span className="text-sm font-normal text-gray-600 ml-2">
                (เจ้าหน้าที่รายวัน: {dailyStaff.length} คน - พยาบาล: {nurses.length} คน, ผู้ช่วย: {assistants.length} คน)
              </span>
            )}
          </h1>
          ...
          <div className="flex justify-center gap-4 mb-4">
            <button
              onClick={() => handleStaffTypeChange('nurse')}
              className={`px-6 py-2 rounded-lg font-medium transition-colors ${
                currentStaffType === 'nurse' 
            ...
            <button
              onClick={() => handleStaffTypeChange('assistant')}
              className={`px-6 py-2 rounded-lg font-medium transition-colors ${
