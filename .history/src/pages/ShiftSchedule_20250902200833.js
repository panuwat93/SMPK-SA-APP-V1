...
const ShiftSchedule = ({ userData }) => {
  // ตรวจสอบสิทธิ์การแก้ไขตารางเวร
  const isSupervisor = userData?.role === 'หัวหน้าหน่วยงาน';
  const hasEditPermission = isSupervisor || userData?.permissions?.editSchedule;
      ...
      <div className="w-full">
        ...
        <div className="mb-6 bg-white/90 backdrop-blur-sm rounded-xl p-6 shadow-lg border border-gray-200">
              ...
              <div className="flex justify-start gap-3">
                ...
                {!hasEditPermission && (
                  <div className="px-3 py-1.5 bg-gray-100 text-gray-600 rounded text-sm font-medium">
                    <span className="text-xs">โหมดอ่านอย่างเดียว</span>
                  </div>
                )}
              </div>
