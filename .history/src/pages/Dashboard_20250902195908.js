          ...
          {isSupervisor ? (
            ...
            <div className="flex items-center space-x-4">
              <div className={`inline-flex items-center px-3 py-1 rounded-full text-xs font-medium ${
                ...
                {hasEditSchedulePermission ? '✅' : '❌'} แก้ไขตารางเวร
              </div>
              <div className={`inline-flex items-center px-3 py-1 rounded-full text-xs font-medium ${
                hasManageAssignmentsPermission 
                  ? 'bg-green-100 text-green-800' 
                  : 'bg-gray-100 text-gray-600'
              }`}>
                {hasManageAssignmentsPermission ? '✅' : '❌'} มอบหมายงาน
              </div>
            </div>
          )}
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div className="bg-white p-6 rounded-lg shadow-md border border-gray-200">
              ...
              <p className="text-gray-600">
                {hasEditSchedulePermission ? 'ดูและแก้ไขตารางเวร' : 'ดูตารางเวรของตนเอง'}
              </p>
            </div>
            
            {/* ตารางมอบหมายงาน - แสดงตามสิทธิ์ */}
            {hasManageAssignmentsPermission && (
              <div className="bg-white p-6 rounded-lg shadow-md border border-gray-200">
                <h3 className="text-xl font-semibold text-dark-blue mb-4">ตารางมอบหมายงาน</h3>
                <p className="text-gray-600">จัดการงานที่ได้รับมอบหมาย</p>
              </div>
            )}
