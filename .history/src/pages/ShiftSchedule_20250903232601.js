  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-indigo-50 to-slate-100">
      ...
      {canEditSchedule && userData?.userType === 'Admin' && (
        <div className="sticky top-0 z-[100] flex items-center justify-center gap-4 bg-gray-100 px-4 py-2 shadow-lg border-b-2 border-gray-300">
        {/* สีตัวอักษร */}
      ...
      <div className="w-full p-4">
        ...
        <div className="mb-6 bg-white/90 backdrop-blur-sm rounded-xl p-6 shadow-lg border border-gray-200">
            ...
            {/* แถบเครื่องมือ - แสดงเฉพาะ Admin */}
            {canEditSchedule && userData?.userType === 'Admin' && (
              <div className="sticky top-0 z-[100] flex items-center justify-center gap-4 bg-gray-100 px-4 py-2 rounded-lg mb-6 shadow-lg border-b-2 border-gray-300">
              {/* สีตัวอักษร */}
              <div className="flex items-center gap-2">
                <span className="text-xs font-medium text-gray-700">สีตัวอักษร:</span>
                <button
