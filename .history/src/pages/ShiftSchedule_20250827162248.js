                 ...
                 <thead className="bg-gradient-to-r from-slate-700 to-slate-800">
                   <tr>
                    ...
                    {nurses.map((member, index) => [
                      ...
                      <tr key={`${member.id}-name`} className="hover:bg-gray-50 border-b border-slate-200">
                      ...
                      // แถวที่ 2: เวร
                      <tr key={`${member.id}-shifts`} className="hover:bg-gray-50 border-b-2 border-slate-300">
                        ...
                        {dateColumns.map(date => (
                          <td key={date.date} className="border border-gray-200 px-2 py-2 text-sm text-gray-900 text-center cursor-pointer hover:bg-blue-50">
                            {editingCell === `${member.id}-${date.date}` ? (
                              ...
                              >
                                {scheduleData[`${member.id}-${date.date}`] || '-'}
                              </div>
                            )}
                          </td>
                        ))}
