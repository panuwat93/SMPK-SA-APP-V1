                  ...
                  <table className="w-full border-collapse border border-gray-300 text-xs">
                    <thead>
                      <tr className="bg-gray-100">
                        <th className="border border-gray-300 px-1 py-1 text-xs font-medium text-gray-700 w-8 sticky left-0 top-0 bg-gray-100 z-20">No.</th>
                        <th className="border border-gray-300 px-1 py-1 text-xs font-medium text-gray-700 w-24 sticky left-8 top-0 bg-gray-100 z-20">ชื่อ-นามสกุล</th>
