  ...
  const autoAssignAssistantShifts = async () => {
    ...
    try {
      ...
      for (let dayIndex = 0; dayIndex < days.length; dayIndex++) {
        ...
        // ตรวจสอบว่าวันนี้มีเวรที่ต้องการจัดครบแล้วหรือไม่ (เช้า 1, บ่าย 1, ดึก 1)
        ...
        // ถ้ามีเวรครบแล้ว (เช้า 1, บ่าย 1, ดึก 1) ให้ข้ามวันนี้
        if (morningCount >= 1 && afternoonCount >= 1 && nightCount >= 1) {
