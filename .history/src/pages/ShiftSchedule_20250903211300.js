                  ...
                  <table className="w-full border-collapse border border-gray-300 text-xs">
                    <thead>
                      <tr className="bg-gray-100">
                        <th className="border border-gray-300 px-0.5 py-0.5 text-xs font-medium text-gray-700 w-4 sticky left-0 top-0 bg-gray-100 z-20">No.</th>
                        <th className="border border-gray-300 px-0.5 py-0.5 text-xs font-medium text-gray-700 w-20 sticky left-4 top-0 bg-gray-100 z-20">ชื่อ-นามสกุล</th>
                        {Array.from({ length: new Date(currentMonth.getFullYear(), currentMonth.getMonth() + 1, 0).getDate() }, (_, i) => {
                          ...
                          const isHolidayDate = holidays.some(h => h.date === date);
                                                      ...
                                                      return (
                              <th key={date} className={`border border-gray-300 px-0.5 py-0.5 text-center w-3 sticky top-0 z-20 ${
                          ...
                          return filteredMembers.map((member, index) => (
                            <React.Fragment key={member.id}>
                              ...
                              <tr className="h-8">
                                                                  <td 
                                    rowSpan={2}
                                    className="border border-gray-300 px-0.5 py-0.5 text-center text-xs font-medium bg-gray-50 align-middle sticky left-0 bg-gray-50 z-10 w-4"
                                  >
                                    {index + 1}
                                  </td>
                                  <td 
                                    rowSpan={2}
                                    className="border border-gray-300 px-0.5 py-0.5 text-center text-xs font-medium align-middle sticky left-4 bg-white z-10 w-12"
                                  >
                                ...
                                {Array.from({ length: new Date(currentMonth.getFullYear(), currentMonth.getMonth() + 1, 0).getDate() }, (_, dayIndex) => {
                                  ...
                                  return (
                                    <td 
                                      ...
                                      className={`border border-gray-300 px-0.5 py-0.5 text-center w-3 ${
