...
const Payroll = ({ userData }) => {
  const payrollForms = [
    {
      id: 'ot-4a',
      name: 'OT-4A รายเดือน OT',
      description: 'แบบฟอร์มคำนวณเงินล่วงเวลา 4A รายเดือน OT',
      path: '/payroll/ot-4a',
      color: 'bg-purple-200 hover:bg-purple-300 text-purple-800'
    },
    {
      id: 'ot-4a-2',
      name: 'OT-4A รายเดือน ค่าเวร',
      description: 'แบบฟอร์มคำนวณเงินล่วงเวลา 4A รายเดือน ค่าเวร',
      path: '/payroll/ot-4a-2',
      color: 'bg-purple-200 hover:bg-purple-300 text-purple-800'
    },
    {
      id: 'ot-4a-3',
      name: 'OT-4A รายวัน OT',
      description: 'แบบฟอร์มคำนวณเงินล่วงเวลา 4A รายวัน OT',
      path: '/payroll/ot-4a-3',
      color: 'bg-purple-200 hover:bg-purple-300 text-purple-800'
    },
    {
      id: 'ot-4c',
      name: 'OT-4C รายวัน วันทำการ',
      description: 'แบบฟอร์มคำนวณเงินล่วงเวลา 4C รายวัน วันทำการ',
      path: '/payroll/ot-4c',
      color: 'bg-orange-200 hover:bg-orange-300 text-orange-800'
    },
    {
      id: 'ot-4c-2',
      name: 'OT-4C รายวัน ค่าเวร',
      description: 'แบบฟอร์มคำนวณเงินล่วงเวลา 4C รายวัน ค่าเวร',
      path: '/payroll/ot-4c-2',
      color: 'bg-orange-200 hover:bg-orange-300 text-orange-800'
    }
  ];
