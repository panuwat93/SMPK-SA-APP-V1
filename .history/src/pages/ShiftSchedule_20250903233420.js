                ...
                <div className="bg-green-100 text-green-800 p-4 border-l-4 border-green-400">
                  <div className="flex items-center justify-between">
                    ...
                    {assistants.length > 5 && (
                      <div className="flex items-center gap-2">
                        <button
                          onClick={scrollAssistantsUp}
                          disabled={visibleAssistantsStart === 0}
                          className={`px-3 py-1 rounded text-sm font-medium transition-colors ${
                            visibleAssistantsStart === 0
                              ? 'bg-gray-300 text-gray-500 cursor-not-allowed'
                        ...
                        <span className="text-sm">
                          {visibleAssistantsStart + 1}-{Math.min(visibleAssistantsStart + 5, assistants.length)} / {assistants.length}
                        </span>
                        <button
                          onClick={scrollAssistantsDown}
                          disabled={visibleAssistantsStart >= assistants.length - 5}
                          className={`px-3 py-1 rounded text-sm font-medium transition-colors ${
                            visibleAssistantsStart >= assistants.length - 5
                              ? 'bg-gray-300 text-gray-500 cursor-not-allowed'
                              : 'bg-green-600 hover:bg-green-700 text-white'
                          }`}
                        >
