      ...
      <div className="w-full">
        ...
        <div className="mb-6 bg-white/90 backdrop-blur-sm rounded-xl p-6 shadow-lg border border-gray-200">
              ...
              <div className="flex justify-start gap-3">
                {/* ปุ่มเปิดสิทธิ์การแก้ไขสำหรับหัวหน้าหน่วยงาน */}
                {userData?.role === 'หัวหน้าหน่วยงาน' && !canEditSchedule && (
                  <button
                    onClick={() => {
                      // TODO: เปิดสิทธิ์การแก้ไข
                      console.log('เปิดสิทธิ์การแก้ไข');
                    }}
                    className="px-3 py-1.5 bg-blue-200 hover:bg-blue-300 text-blue-800 rounded text-sm font-medium transition-colors"
                  >
