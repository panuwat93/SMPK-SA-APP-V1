              ...
              <div className="flex items-center gap-2">
                ...
                <div className="flex items-center gap-2 ml-2">
                  ...
                  <button
                    ...
                    className="px-3 py-2 rounded text-red-600 font-medium text-sm transition-all hover:scale-105 bg-white hover:bg-gray-100 border border-gray-300"
                    title="ช (สีแดง)"
                  >
                    ช
                  </button>
                ...
                <div className="flex items-center gap-2 ml-2">
                  ...
                  <button
                    ...
                    className="px-3 py-2 rounded text-black font-medium text-sm transition-all hover:scale-105 bg-white hover:bg-gray-100 border border-gray-300"
                    title="ช (สีดำ)"
                  >
                    ช
                  </button>
