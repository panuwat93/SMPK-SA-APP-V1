  ...
  return (
    <div className="min-h-screen bg-gray-50 p-6">
      <div className="max-w-7xl mx-auto">
        <div className="print-content bg-white p-8 shadow-lg" style={{ fontFamily: 'Kanit, sans-serif' }}>
          {/* Header */}
          <div className="relative mb-6">
            <div className="text-center">
              <h1 className="text-lg font-bold mb-4">หลักฐานการจ่ายเงินค่าตอบแทนการปฏิบัติงาน</h1>
          ...
          <div className="grid grid-cols-2 gap-8 mt-6">
            ...
            <div className="text-left">
              ...
              <div className="space-y-4">
                <div>
                  <div className="border-b border-gray-400 mb-2 h-4 w-48"></div>
