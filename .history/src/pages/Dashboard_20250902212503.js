                                  ...
                                  {topShift && topShift.trim() !== '' && (
                                    <div 
                                      className={`text-xs px-1 py-0.5 rounded mb-1 ${
                                        typeof getShiftColor(topShift) === 'string' 
                                          ? getShiftColor(topShift) 
                                          : getShiftColor(topShift).className
                                      }`}
                                      style={typeof getShiftColor(topShift) === 'object' ? {
                                        backgroundColor: getShiftColor(topShift).backgroundColor,
                                        color: getShiftColor(topShift).color
                                      } : {}}
                                    >
                                  ...
                                  {bottomShift && bottomShift.trim() !== '' && (
                                    <div 
                                      className={`text-xs px-1 py-0.5 rounded ${
                                        typeof getShiftColor(bottomShift) === 'string' 
                                          ? getShiftColor(bottomShift) 
                                          : getShiftColor(bottomShift).className
                                      }`}
                                      style={typeof getShiftColor(bottomShift) === 'object' ? {
                                        backgroundColor: getShiftColor(bottomShift).backgroundColor,
                                        color: getShiftColor(bottomShift).color
                                      } : {}}
                                    >
