                  ...
                  <table className="w-full border-collapse">
                    <thead>
                      <tr className="bg-gray-50">
                        <th className="border border-gray-300 px-3 py-2 text-sm font-medium text-gray-700 w-10 sticky left-0 bg-gray-50 z-10">No.</th>
                        <th className="border border-gray-300 px-3 py-2 text-sm font-medium text-gray-700 w-40 sticky left-10 bg-gray-50 z-10">ชื่อ-นามสกุล</th>
                        {days.map((day, index) => (
                  ...
                  <table className="w-full border-collapse border border-gray-300">
                    <thead>
                      <tr className="bg-gray-100">
                        <th className="border border-gray-300 px-3 py-2 text-sm font-medium text-gray-700 w-10 sticky left-0 bg-gray-100 z-10">No.</th>
                        <th className="border border-gray-300 px-3 py-2 text-sm font-medium text-gray-700 w-40 sticky left-10 bg-gray-100 z-10">ชื่อ-นามสกุล</th>
                          ...
                          return filteredMembers.map((member, index) => (
                            <React.Fragment key={member.id}>
                              ...
                              <tr className="h-8">
                                <td 
                                  rowSpan={2}
                                  className="border border-gray-300 px-3 py-2 text-center text-sm font-medium bg-gray-50 align-middle"
                                >
                                  {index + 1}
                                </td>
                                <td 
                                  rowSpan={2}
                                  className="border border-gray-300 px-3 py-2 text-center text-sm font-medium align-middle"
                                >
