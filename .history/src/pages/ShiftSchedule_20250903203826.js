                          ...
                          return filteredMembers.map((member, index) => (
                            <React.Fragment key={member.id}>
                              ...
                              <tr className="h-8">
                                <td 
                                  rowSpan={2}
                                  className="border border-gray-300 px-1 py-1 text-center text-xs font-medium bg-gray-50 align-middle sticky left-0 bg-gray-50 z-10 w-8"
                                >
                                  {index + 1}
                                </td>
                                <td 
                                  rowSpan={2}
                                  className="border border-gray-300 px-1 py-1 text-center text-xs font-medium align-middle sticky left-8 bg-white z-10 w-24"
                                >
