...
const ExchangeShift = ({ userData }) => {
  ...
  const fetchAllExchangeRequests = async () => {
    try {
      // TODO: ดึงข้อมูลจาก Firebase
      // ตอนนี้ใช้ข้อมูลตัวอย่างสำหรับหัวหน้า
      const mockAllRequests = [
        {
          ...
          targetId: 'user2',
          targetName: 'สมหญิง รักดี',
          date: '2025-09-05',
          myShiftType: 'top',
          myShiftValue: 'ช',
          otherShiftType: 'bottom',
          otherShiftValue: 'บ',
          status: 'pending',
        ...
        },
        {
          id: '2',
          requesterId: 'user3',
          requesterName: 'สมศักดิ์ เก่งมาก',
          targetId: 'user4',
          targetName: 'สมพร ดีใจ',
          date: '2025-09-07',
          myShiftType: 'bottom',
          myShiftValue: 'ด',
          otherShiftType: 'top',
      ...
      setAllExchangeRequests(mockAllRequests);
    } catch (error) {
