    ...
    <Router>
      <AuthWrapper>
        {({ user, userData, onLogout }) => (
                                  <div className="flex h-screen bg-gradient-to-br from-blue-50 via-indigo-50 to-slate-100">
            {/* ปุ่ม Hamburger Menu */}
            <div className="fixed top-4 left-4 z-40">
                                          <button
                              onClick={() => setSidebarOpen(true)}
                              className="p-3 rounded-xl bg-white/90 backdrop-blur-sm shadow-xl text-slate-700 hover:text-slate-900 hover:bg-white border border-blue-200/50"
                            >
