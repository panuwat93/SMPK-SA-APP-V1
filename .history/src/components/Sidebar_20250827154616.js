...
const Sidebar = ({ onLogout, user, isOpen, onToggle }) => {
  ...
  return (
    <div className={`fixed inset-y-0 left-0 z-50 bg-white/95 backdrop-blur-sm shadow-2xl border-r border-blue-200/50 transform transition-transform duration-300 ease-in-out ${
